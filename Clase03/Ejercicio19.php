...
$arrayDeAutos = array();
array_push($arrayDeAutos,$autoUno);
array_push($arrayDeAutos,$autoTres);
array_push($arrayDeAutos,$autoCinco);
$autoUno->GuardarAuto($arrayDeAutos);

$arrayDeAutosLeidos = array();
echo "<br>";
$arrayDeAutosLeidos = $autoUno->LeerAutos();
echo "Autos leidos CSV: ";
echo "<br>";
foreach ($arrayDeAutosLeidos as $auto)
{
